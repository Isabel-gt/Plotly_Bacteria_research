...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var filterNumber = samparray.filter(data => data.id == sample);
    console.log(filterNumber)

    //  5. Create a variable that holds the first sample in the array.
    var result2 = filterNumber[0];
    console.log(result2);
...
var metadataF= data.metadata;
console.log(metadataF)

var metadataFilter = metadataF.filter(data => data.id == sample);
console.log(metadataFilter);

// 2. Create a variable that holds the first sample in the metadata array.
var firstSamp = metadataFilter[0];
console.log(firstSamp)

// 3. Create a variable that holds the washing frequency.
var washingFrec = firstSamp.wfreq;
console.log(washingFrec);   
